    ...
    <Layout>
      <div className={templateStyles.container}>
        ...
        <div className={templateStyles.wrapper__button}>
          {data.linktoproject ? (
            <>
              <a  target="_blank" href={data.linktoproject}>
                <div className={templateStyles.button__mobile}>Podgląd projektu</div>
              </a>
            </>
          ) : (
            <>
              <p>Podgląd projektu niedostępny</p>
            </>
          )}
          <button
            className={templateStyles.button__mobile}
        ...
        <img
          id="project__img"
          className={templateStyles.project__img__desktop}
          src={data.screendesktop.url}
          alt={"Image" + data.name}
        />
      </div>
    </Layout>
