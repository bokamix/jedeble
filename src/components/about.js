...
const About = () => {
  return ( <
    ...
    <
    div className = {
      aboutStyles.contact__section
    } >
    <
    div className = {
      aboutStyles.wrapper__logos
    } >
    <
    h2 > Technology < /h2> <
    div className = {
      aboutStyles.technology__logos__mobile
    } >
    <
    div className = {
      aboutStyles.box
    ...
    <
    div className = {
      aboutStyles.wrapper__logos__mobile
    } >
    <
    img alt = "uxpin"
    src = {
    ...
    <
    img alt = "Facebook Ads"
    src = {
      FacebookADS
    }
    /> <
    img alt = "Ableton Live"
    src = {
      Ableton
    }
    /> <
    img alt = "Sony Vegas Pro"
    src = {
      SonyVegasPro
    }
    /> <
