...
<h3>to to tam</h3>
  <p>Data from 2018: BuiltWith.com, W3tech.com, SimilarTech, Google Trends.</p>
      ...
      <div className={TitleSectionStyle.wrapper__statistics}><div>
      <span>59%</span><p>Wordpress  </p>
  <span>6.7%</span><p>Joomla </p></div>
     <div>  <span>4,7%</span><p>Drupal </p>
  <span> 2.3%</span><p>Magento</p></div>
      </div></div>
...
<h3>BlaBla Bla</h3>
  <p>data from wearesocial.com, hootsuite.com</p>
      <div className={TitleSectionStyle.wrapper__statistics}><div><span>64%</span> <p> Mobile</p>
      <span>57% </span><p>desktop</p></div>
     <div> <span>45% </span><p>Social media user</p>
      <span>43% </span> <p>Mobile social media user</p></div>
      </div></div>
