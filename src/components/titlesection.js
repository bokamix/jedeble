  ...
  return (
    <>
      <div className={TitleSectionStyle.container__header}>
        <div className={TitleSectionStyle.main__title}>
          <p>
        ...
        <div className={TitleSectionStyle.img__titleSection}>
          <img src={internetImg} alt="statistic" />
        </div>
      </div>
      ...
      <div className={TitleSectionStyle.card__section}>
        <div className={TitleSectionStyle.about__container}>
          <h2>About</h2>
          <p>
            I specialize in creating commercial websites, online stores
            (and graphics for them), product catalogs and blogs. I focus on
            developing Front-end applications with special attention to user
            experience.
          </p>
        </div>
